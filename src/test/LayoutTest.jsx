    ...
    return <div className="row">
        ...
        <small>UI ahihi</small>
          ...
          Color
                ...
                <li className="c-sidebar-nav c-sidebar-nav-item">
                    <i className="fa fa-pencil c-sidebar-nav-icon" aria-hidden="true"></i>
          Typography
        </li>
                <li className="c-sidebar-nav c-sidebar-nav-item-category">COMPONENTS</li>
                <li className="c-sidebar-nav c-sidebar-nav-item">
                    <i className="fa fa-bug c-sidebar-nav-icon" aria-hidden="true"></i>
          Base
        </li>
                <li className="c-sidebar-nav c-sidebar-nav-item">
                    <i className="fa fa-location-arrow c-sidebar-nav-icon" aria-hidden="true"></i>
          Buttons
        </li>
                <li className="c-sidebar-nav c-sidebar-nav-item">
                    <i className="fa fa-pie-chart c-sidebar-nav-icon" aria-hidden="true"></i>
          Charts
        </li>
                <li className="c-sidebar-nav c-sidebar-nav-item">
                    <i className="fa fa-star-o c-sidebar-nav-icon" aria-hidden="true"></i>
          Icons
        </li>
                <li className="c-sidebar-nav c-sidebar-nav-item">
                    <i className="fa fa-bell-o c-sidebar-nav-icon" aria-hidden="true"></i>
          Notifications</li>
                <li className="c-sidebar-nav c-sidebar-nav-item">
                    <i className="fa fa-wpforms c-sidebar-nav-icon" aria-hidden="true"></i>
          Widgets
          <mark>NEW</mark>
                </li>
          ...
          Page
                ...
                <li className="c-sidebar-nav c-siderbar-nav-item">
                    <i className="fa fa-cloud-download c-sidebar-nav-icon" aria-hidden="true"></i>
          Download CoreUI</li>
                <li className="c-sidebar-nav c-siderbar-nav-item">
                    <i className="fa fa-book c-sidebar-nav-icon" aria-hidden="true"></i>
          TryCoreUIPRO</li>
            ...
            <header>
                <div className="row row-c-header-bars" style={{ marginBottom: 0 }}>
                    ...
                    <ul className="c-header-nav c-header-nav-right">
                        ...
                        <li className="c-header-nav-item">
                            <img src="./img/chân dung.jpg" className="c-header-nav-item-img" alt="photo1" />
                        </li>
                        <li className="c-header-nav-item">
                ...
                <div className="row row-c-header-bars" style={{ marginBottom: 0 }}>
                    ...
                    <div className="c-header-item-right">
                        ...
                        <a className="c-header-item-right-title">
                            <i className="fa fa-ils" aria-hidden="true">Dashboard</i>
                        </a>
                        <a className="c-header-item-right-title">
